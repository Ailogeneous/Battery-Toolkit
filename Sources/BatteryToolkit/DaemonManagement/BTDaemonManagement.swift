...
import BTShared
import SimpleAuth
import CSIdentification

public enum BTDaemonManagement {
    @BTBackgroundActor public static func start() async -> BTDaemonManagement.Status {
    ...
    @BTBackgroundActor public static func upgrade() async -> BTDaemonManagement.Status {
        if #available(macOS 13.0, *) {
    ...
    @BTBackgroundActor public static func remove() async throws {
    ...
    public static func daemonUpToDate(daemonId: Data?) -> Bool {
