...
public extension BTDaemonManagement.Status {
...
public extension BTDaemonManagement {
    ...
    enum Service {
        ...
        @BTBackgroundActor public static func register() async -> BTDaemonManagement.Status {
        ...
        @BTBackgroundActor public static func unregister() async throws {
