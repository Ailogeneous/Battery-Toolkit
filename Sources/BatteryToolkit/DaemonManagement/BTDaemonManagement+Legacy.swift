...
public extension BTDaemonManagement {
    ...
    enum Legacy {
        ...
        public static func register() async -> BTDaemonManagement.Status {
        ...
        public static func unregister(simpleAuth: SimpleAuthRef) {
        ...
        public static func unregisterCleanup() async throws {
            os_log("Unregistering legacy helper")
