...
public enum BTLocalization {
    public enum Prompts {
        ...
        public static let openSystemSettings = NSLocalizedString(
            "Open System Settings",
            comment: "Prompt button to open System Settings"
        )

        public static let quitMessage = NSLocalizedString(
            "Quit Battery Toolkit?",
            comment: "Prompt caption asking whether to quit the app"
        )

        public static let quitInfo = NSLocalizedString(
        ...
        public static let quitInfoMacOS13 = NSLocalizedString(
