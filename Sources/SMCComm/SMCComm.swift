...
public extension SMCComm {
    ...
    struct KeyInfo : Sendable {
        public let key: SMCComm.Key
        public let info: SMCComm.KeyInfoData
    }

    enum KeyTypes {
        public static let ui8  = SMCComm.KeyType("u", "i", "8", " ")
        public static let ui32 = SMCComm.KeyType("u", "i", "3", "2")
        public static let hex  = SMCComm.KeyType("h", "e", "x", "_")
    }
...
public enum SMCComm {
    ...
    public static func getKeyInfo(key: SMCComm.Key)
        -> SMCComm.KeyInfoData?
    {
    ...
    public static func keySupported(keyInfo: SMCComm.KeyInfo) -> Bool {
    ...
    public static func readKey(key: SMCComm.Key, dataSize: Int) -> [UInt8]? {
    ...
    public static func writeKey(key: SMCComm.Key, bytes: [UInt8]) -> Bool {
