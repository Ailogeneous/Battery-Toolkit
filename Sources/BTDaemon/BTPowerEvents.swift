...
@MainActor
public enum BTPowerEvents {
    public static var updating = false

    public private(set) static var chargingMode = BTStateInfo.ChargingMode.standard
    public private(set) static var unlimitedPower = false
    ...
    public static func wakeFromSleep() {
        //
    ...
    public static func chargeToLimit() -> Bool {
        self.chargingMode = .toLimit
        return self.enableBelowLimitMode(limit: BTSettings.maxCharge)
    }

    public static func disableCharging(percent: UInt8) -> Bool {
    ...
    public static func chargeToFull() -> Bool {
        self.chargingMode = .toFull
        return self.enableBelowLimitMode(limit: 100)
    }

    public static func getChargingProgress() -> BTStateInfo.ChargingProgress {
